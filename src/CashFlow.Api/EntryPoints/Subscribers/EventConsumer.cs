using global::CashFlow.Api.Application.EventHandlers;
using global::CashFlow.Api.Infrastructure.Settings;
using MassTransit;
using CashFlow.Api.Domain.Events;
using Polly;
using System.Net.Sockets;
using static global::CashFlow.Api.Infrastructure.Settings.RabbitMQ;

namespace CashFlow.Api.EntryPoint.Consumer;
    ...
    where T : class, IDomainEvent
{
    ...
    private readonly IEventHandler<T, Guid> _handler;

    public EventConsumer(
        ILogger<EventConsumer<T>> logger,
        IAppSettings appSettings,
        IPublishEndpoint publishEndpoint,
        IEventHandler<T, Guid> handler)
    {
        _logger = logger;
